...
-(void)removeFromFav:(void (^)(BOOL))block withPhotoID:(NSString *)photoID
{
    ...
    NSString *signature = [[NSString alloc] initWithFormat:kMD5RemoveFavString, token, frob, photoID];
    
    NSString *url = [[NSString alloc] initWithFormat:kRemoveFavURL, token, frob, [signature MD5String], photoID];

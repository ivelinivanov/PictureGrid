...
@implementation MyPhotosWebService
...
-(void)getPhotos:(void (^)(NSMutableArray *))block
{
    ...
    NSString *signature = [[NSString alloc] initWithFormat:kMD5MyPhotosString, token, frob];
    
    NSString *url = [[NSString alloc] initWithFormat:kMyPhotosURL, token, frob, [signature MD5String]];
